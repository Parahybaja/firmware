...
static const gpio_num_t fuel_level_pin = GPIO_NUM_34;
...
void app_main(void) {
    ...
    xTaskCreatePinnedToCore(
    task_fuel_level,       // task function
    "fuel sensor",   // task name
    4096,               // stack size
    (void*)fuel_level_pin, // parameters
    8,                  // priority
    &th_fuel_level,        // handler 
    APP_CPU_NUM         // core number
    );
